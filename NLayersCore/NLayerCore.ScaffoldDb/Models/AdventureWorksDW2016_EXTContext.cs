...
{
    public partial class AdventureWorksDW2016_EXTContext : DbContext
    {
        public AdventureWorksDW2016_EXTContext()
        {
        }

        public AdventureWorksDW2016_EXTContext(DbContextOptions<AdventureWorksDW2016_EXTContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<FactResellerSalesXlCci> FactResellerSalesXlCci { get; set; }
        public virtual DbSet<FactResellerSalesXlPageCompressed> FactResellerSalesXlPageCompressed { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=beserver;database=AdventureWorksDW2016_EXT;user=sa;password=0101;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FactResellerSalesXlCci>(entity =>
            {
                entity.HasKey(e => new { e.SalesOrderNumber, e.SalesOrderLineNumber })
                    .HasName("PK_FactResellerSalesXL_CCI_SalesOrderNumber_SalesOrderLineNumber")
                    .ForSqlServerIsClustered(false);

                entity.ToTable("FactResellerSalesXL_CCI");

                entity.HasIndex(e => new { e.ProductKey, e.OrderDateKey, e.DueDateKey, e.ShipDateKey, e.ResellerKey, e.EmployeeKey, e.PromotionKey, e.CurrencyKey, e.SalesTerritoryKey, e.SalesOrderNumber, e.SalesOrderLineNumber, e.RevisionNumber, e.OrderQuantity, e.UnitPrice, e.ExtendedAmount, e.UnitPriceDiscountPct, e.DiscountAmount, e.ProductStandardCost, e.TotalProductCost, e.SalesAmount, e.TaxAmt, e.Freight, e.CarrierTrackingNumber, e.CustomerPonumber, e.OrderDate, e.DueDate, e.ShipDate })
                    .HasName("IndFactResellerSalesXL_CCI");
                ...
                entity.HasOne(d => d.CurrencyKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.CurrencyKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimCurrency");

                entity.HasOne(d => d.DueDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCciDueDateKeyNavigation)
                    .HasForeignKey(d => d.DueDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimDate1");

                entity.HasOne(d => d.EmployeeKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.EmployeeKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimEmployee");

                entity.HasOne(d => d.OrderDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCciOrderDateKeyNavigation)
                    .HasForeignKey(d => d.OrderDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimDate");

                entity.HasOne(d => d.ProductKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.ProductKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimProduct");

                entity.HasOne(d => d.PromotionKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.PromotionKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimPromotion");

                entity.HasOne(d => d.ResellerKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.ResellerKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimReseller");

                entity.HasOne(d => d.SalesTerritoryKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCci)
                    .HasForeignKey(d => d.SalesTerritoryKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimSalesTerritory");

                entity.HasOne(d => d.ShipDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlCciShipDateKeyNavigation)
                    .HasForeignKey(d => d.ShipDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_CCI_DimDate2");
            });

            modelBuilder.Entity<FactResellerSalesXlPageCompressed>(entity =>
            {
                entity.HasKey(e => new { e.SalesOrderNumber, e.SalesOrderLineNumber })
                    .HasName("PK_FactResellerSalesXL_PageCompressed_SalesOrderNumber_SalesOrderLineNumber");

                entity.ToTable("FactResellerSalesXL_PageCompressed");
                ...
                entity.HasOne(d => d.CurrencyKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.CurrencyKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimCurrency");

                entity.HasOne(d => d.DueDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressedDueDateKeyNavigation)
                    .HasForeignKey(d => d.DueDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimDate1");

                entity.HasOne(d => d.EmployeeKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.EmployeeKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimEmployee");

                entity.HasOne(d => d.OrderDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressedOrderDateKeyNavigation)
                    .HasForeignKey(d => d.OrderDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimDate");

                entity.HasOne(d => d.ProductKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.ProductKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimProduct");

                entity.HasOne(d => d.PromotionKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.PromotionKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimPromotion");

                entity.HasOne(d => d.ResellerKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.ResellerKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimReseller");

                entity.HasOne(d => d.SalesTerritoryKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressed)
                    .HasForeignKey(d => d.SalesTerritoryKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimSalesTerritory");

                entity.HasOne(d => d.ShipDateKeyNavigation)
                    .WithMany(p => p.FactResellerSalesXlPageCompressedShipDateKeyNavigation)
                    .HasForeignKey(d => d.ShipDateKey)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_FactResellerSalesXL_PageCompressed_DimDate2");
            });
